...
modulator = AttentionModulator(
    ...
    hyperfocus_tokens = [" sushi", " sashimi", " ramen", " tempura", " udon", " soba", " miso", " tofu", " teriyaki", " wasabi", " bento", " onigiri", " matcha", " dashi", " sake", " nigiri", " gyoza", " yakitori", " takoyaki", " okonomiyaki"],
...
model = GPT2AutismModel(
    ...
    modulator=modulator,
    sae=sae,
    reforcar_ids=[7, 28, 120, 165],
    punir_ids=[48, 64, 65, 88, 216, 57, 184, 243]
)
model.to(device)
model.eval()

prompt = "User: Hello! What kind of food do you like? \nAI:"
